...
main(int argc, char* argv[])
{
  ...
  1d:	e8 01 03 00 00       	call   323 <getpid>
  22:	83 c4 0c             	add    $0xc,%esp
  25:	50                   	push   %eax
  26:	68 45 07 00 00       	push   $0x745
  2b:	6a 01                	push   $0x1
  2d:	e8 ce 03 00 00       	call   400 <printf>
    printf(1, "My gpid is %d\n", getgpid());
  32:	e8 0c 03 00 00       	call   343 <getgpid>
  37:	83 c4 0c             	add    $0xc,%esp
  3a:	50                   	push   %eax
  3b:	68 53 07 00 00       	push   $0x753
  40:	6a 01                	push   $0x1
 ...
 35c:	89 d1                	mov    %edx,%ecx
{
 ...
 389:	0f b6 92 c4 07 00 00 	movzbl 0x7c4(%edx),%edx
 ...
 409:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 479:	ff 24 85 6c 07 00 00 	jmp    *0x76c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 587:	90                   	nop
          s = "(null)";
 588:	ba 62 07 00 00       	mov    $0x762,%edx
        while(*s != 0){
 ...
 5a1:	a1 6c 0a 00 00       	mov    0xa6c,%eax
{
 ...
 5e1:	5b                   	pop    %ebx
  freep = p;
 5e2:	89 15 6c 0a 00 00    	mov    %edx,0xa6c
}
 5e8:	5e                   	pop    %esi
 5e9:	5f                   	pop    %edi
 5ea:	5d                   	pop    %ebp
 ...
 619:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 61c:	89 15 6c 0a 00 00    	mov    %edx,0xa6c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 3d 6c 0a 00 00    	mov    0xa6c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67f:	73 4f                	jae    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	8b 3d 6c 0a 00 00    	mov    0xa6c,%edi
 ...
 6aa:	e8 f1 fe ff ff       	call   5a0 <free>
  return freep;
 6af:	8b 15 6c 0a 00 00    	mov    0xa6c,%edx
 ...
 6dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6df:	89 15 6c 0a 00 00    	mov    %edx,0xa6c
}
 ...
 6ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 6c 0a 00 00 70 	movl   $0xa70,0xa6c
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	bf 70 0a 00 00       	mov    $0xa70,%edi
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 70 0a 00 00 70 	movl   $0xa70,0xa70
 706:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 709:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 70b:	c7 05 74 0a 00 00 00 	movl   $0x0,0xa74
 712:	00 00 00 
    if(p->s.size >= nunits){
